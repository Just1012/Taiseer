                ...
                <ul class="nav" ui-nav>
                    ...
                    <li>
                        <a href="{{ route('currency.index') }}"
                            ...
                            <span class="nav-text">{{ __('backend.currency') }}</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ route('country.index') }}" onclick="location.href='{{ route('country.index') }}'">
                            <span class="nav-icon">
                    ...
                    <li>
                        <a href="{{ route('typeActivity.index') }}"
                            ...
                            <span class="nav-text">{{ __('backend.typeActivity') }}</span>
                        </a>
                    </li>
