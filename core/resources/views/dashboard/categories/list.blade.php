                                ...
                                @foreach ($Section->fatherSections as $subSection)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @if (@Auth::user()->permissionsGroup->delete_status)
                                                <button class="btn btn-sm warning" type="button"
                                                    onclick="DeleteCategory('{{ $subSection->id }}')"
                                                    data-toggle="tooltip"
                                                    data-original-title="{{ __('backend.delete') }}">
                                                    <i class="material-icons">&#xe872;</i>
                                                </button>
                                        ...
                                        <tr>
                                            <td class="dker"><label class="ui-check m-a-0">
                                                    <input type="checkbox" name="ids[]"
                                                        value="{{ $subSection2->id }}"><i class="dark-white"></i>
                                                    {!! Form::hidden('row_ids[]', $subSection2->id, ['class' => 'form-control row_no']) !!}
                                                </label>
                                            </td>
                                            ...
                                            <td class="h6">
                                                ...
                                                <img src="{{ asset('assets/dashboard/images/treepart_sub_' . @Helper::currentLanguage()->direction . '.png') }}"
                                                    class="submenu_tree">
                                                {!! Form::text('row_no_' . $subSection2->id, $subSection2->row_no, [
                                                    'class' => 'form-control row_no',
                                                    'id' => 'row_no',
                                                ]) !!}
                                                @if ($subSection2->icon != '')
                                            ...
                                            <td class="text-center">
                                                <i
                                                    class="fa {{ $subSection2->status == 1 ? 'fa-check text-success' : 'fa-times text-danger' }} inline"></i>
                                            </td>
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm info"
                                                    ...
                                                    data-toggle="tooltip"
                                                    data-original-title="{{ __('backend.viewDetails') }}"
                                                    target="_blank">
                                                    <i class="material-icons">&#xe8f4;</i>
                                                </a>
                                                ...
                                                @if (@Auth::user()->permissionsGroup->delete_status)
                                                    <button class="btn btn-sm warning" type="button"
                                                        onclick="DeleteCategory('{{ $subSection2->id }}')"
                                                        data-toggle="tooltip"
                                                        data-original-title="{{ __('backend.delete') }}">
                                                        <i class="material-icons">&#xe872;</i>
                                                    </button>
