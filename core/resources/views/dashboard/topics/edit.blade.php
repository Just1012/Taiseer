    ...
    <div class="padding">
                    ...
                    <li class="nav-item inline dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-scale pull-right">
                            ...
                            <a class="dropdown-item"
                                href="{{ @$Topic->webmasterSection->type == 4 || @$Topic->webmasterSection->type == 6 ? route('topicView', ['webmasterId' => @$Topic->webmasterSection->id, 'id' => $Topic->id]) : Helper::topicURL($Topic->id) }}"
        ...
        <div class="box nav-active-border b-info">
            ...
            <div class="tab-content clear b-t">
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body">
                        ...
                        <div class="form-group row" id="company_id_section" style="display:{{ $style }}">
                            ...
                            <div class="col-sm-10">
                                <select name="company_id" id="company_id" class="form-control c-select">
                                    ...
                                    @foreach ($companies as $company)
                                        <?php
                                        if ($company->$title_var != '') {
                                            $title = $company->$title_var;
                                        } else {
                                            $title = $company->$title_var2;
                                        }
                                        ?>
                                        <option value="{{ $company->id }}"
                                            {{ $Topic->company_id == $company->id ? 'selected' : '' }}>
                                            {!! $title !!}
                                        </option>
                                    @endforeach
                                </select>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <div class='input-group date' ui-jp="datetimepicker"
                                            ...
                                            {!! Form::text('date', Helper::formatDate($Topic->date), [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'id' => 'date',
                                                'required' => '',
                        ...
                        @else
                            {!! Form::hidden('date', $Topic->date, ['placeholder' => '', 'class' => 'form-control', 'id' => 'date']) !!}
                        @endif
            ...
            locale:'{{ @Helper::currentLanguage()->code }}'
                                            ...
                                            {!! Form::text('expire_date', Helper::formatDate($Topic->expire_date), [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'id' => 'expire_date',
                                            ]) !!}
                            ...
                            @foreach (Helper::languagesList() as $ActiveLanguage)
                                @if ($ActiveLanguage->box_status)
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            {!! Form::text('title_' . @$ActiveLanguage->code, $Topic->{'title_' . @$ActiveLanguage->code}, [
                                                'placeholder' => '',
                                                'class' => 'form-control',
                                                'required' => '',
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                @if (Helper::GeneralWebmasterSettings('text_editor') == 2)
                                                    <div>
                                                        {!! Form::textarea('details_' . @$ActiveLanguage->code, $Topic->{'details_' . @$ActiveLanguage->code}, [
                                                            'placeholder' => '',
                        ...
                        @if ($WebmasterSection->type == 2)
                                ...
                                <div class="col-sm-10">
                                    <div class="radio">
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '0', $Topic->video_type == 0 ? true : false, [
                                                'id' => 'video_type1',
                                                'class' => 'has-value',
                                                'onclick' =>
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '1', $Topic->video_type == 1 ? true : false, [
                                                'id' => 'video_type2',
                                                'class' => 'has-value',
                                                'onclick' =>
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '2', $Topic->video_type == 2 ? true : false, [
                                                'id' => 'video_type2',
                                                'class' => 'has-value',
                                                'onclick' =>
                                        ...
                                        &nbsp; &nbsp;
                                        <label class="ui-check ui-check-md">
                                            {!! Form::radio('video_type', '3', $Topic->video_type == 3 ? true : false, [
                                                'id' => 'video_type3',
                                                'class' => 'has-value',
                                                'onclick' =>
                            ...
                            <div class="form-group row" id="youtube_link_div"
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('youtube_link', $Topic->video_file, [
                            ...
                            <div class="form-group row" id="vimeo_link_div"
                                ...
                                <div class="col-sm-10">
                                    {!! Form::text('vimeo_link', $Topic->video_file, [
                            ...
                            <div class="form-group row" id="embed_link_div"
                                ...
                                <label for="embed_link"
                                    class="col-sm-2 form-control-label">{!! __('backend.bannerVideoUrl2') !!}</label>
                                <div class="col-sm-10">
                                    {!! Form::textarea('embed_link', $Topic->video_file, [
                                        'placeholder' => '',
                                        'class' => 'form-control',
                                        'id' => 'embed_link',
                                        'dir' => 'ltr',
                                ...
                                <div class="col-sm-10">
                                    @if ($Topic->audio_file != '')
                                        <div class="box p-a-xs">
                                            ...
                                            <br>
                                            <a target="_blank"
                                                href="{{ asset('uploads/topics/' . $Topic->audio_file) }}">
                                                {{ $Topic->audio_file }} </a>
                                        </div>
                                    @endif
                                ...
                                <div class="col-sm-10">
                                    @if ($Topic->attach_file != '')
                                        <div id="topic_attach" class="col-sm-4 box p-a-xs">
                                            <a target="_blank"
                                                href="{{ asset('uploads/topics/' . $Topic->attach_file) }}">
                                                {{ $Topic->attach_file }} </a>
                                            <br>
                            ...
                            @if ($WebmasterSection->case_status)
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio">
                                            <label class="ui-check ui-check-md">
                                                {!! Form::radio('status', '1', $Topic->status == 1 ? true : false, ['id' => 'status1', 'class' => 'has-value']) !!}
                                                <i class="dark-white"></i>
                                                {{ __('backend.active') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="ui-check ui-check-md">
                                                {!! Form::radio('status', '0', $Topic->status == 0 ? true : false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                                <i class="dark-white"></i>
