                                    ...
                                    <div class="col-sm-10">
                                        <label class="md-check">
                                            <input type="checkbox" name="{{ 'customField_' . $customField->id }}"
                                                value="1" id="{{ 'customField_' . $customField->id }}"
                                                class="has-value">
                                            <i class="blue"></i>
                                            {!! $cf_title !!}
                                            {!! $cf_land_identifier !!}
                    ...
                    @if ($WebmasterSection->case_status)
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <div class="radio">
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '1', true, ['id' => 'status1', 'class' => 'has-value']) !!}
                                        <i class="dark-white"></i>
                                        {{ __('backend.active') }}
                                    </label>
                                    &nbsp; &nbsp;
                                    <label class="ui-check ui-check-md">
                                        {!! Form::radio('status', '0', false, ['id' => 'status2', 'class' => 'has-value']) !!}
                                        <i class="dark-white"></i>
