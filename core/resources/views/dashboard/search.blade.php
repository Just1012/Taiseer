...
@section('content')
    <div class="padding">
        ...
        {{ Form::close() }}
        <p class="m-b-md">
            <strong>{{ $totalcount = count($Topics) + count($Sections) + count($Contacts) + count($Events) + count($Webmails) + count($company) + count($shipment) }}</strong>
        ...
        <ul class="nav nav-sm nav-pills nav-active-primary clearfix">
            @if (count($Topics) > 0)
                <li class="nav-item">
                    <a class="nav-link {{ $active_tab == 1 ? 'active' : '' }}" data-toggle="tab" data-target="#tab_1">
                        {{ __('backend.pages') }}
            ...
            @if (count($Sections) > 0)
                <li class="nav-item">
                    <a class="nav-link {{ $active_tab == 2 ? 'active' : '' }}" data-toggle="tab" data-target="#tab_2">
            ...
            @if (count($Contacts) > 0)
                <li class="nav-item">
                    <a class="nav-link {{ $active_tab == 3 ? 'active' : '' }}" data-toggle="tab" data-target="#tab_3">
            ...
            @if (count($Events) > 0)
                <li class="nav-item">
                    <a class="nav-link {{ $active_tab == 4 ? 'active' : '' }}" data-toggle="tab" data-target="#tab_4">
            ...
            @if (count($Webmails) > 0)
                <li class="nav-item">
                    <a class="nav-link {{ $active_tab == 5 ? 'active' : '' }}" data-toggle="tab" data-target="#tab_5">
            ...
            @if (count($company) > 0)
                <li class="nav-item">
                    <a class="nav-link {{ $active_tab == 6 ? 'active' : '' }}" data-toggle="tab" data-target="#tab_6">
                        {{ __('backend.company') }}
                        <span class="label label-xs primary m-l-xs">{{ count($company) }}</span></a>
                </li>
            @endif
            @if (count($shipment) > 0)
                <li class="nav-item">
                    <a class="nav-link {{ $active_tab == 7 ? 'active' : '' }}" data-toggle="tab" data-target="#tab_7">
                        {{ __('backend.shipment') }}
                        <span class="label label-xs primary m-l-xs">{{ count($shipment) }}</span></a>
                </li>
            @endif
        </ul>
        ...
        <div class="tab-content">
                                ...
                                <li class="list-item">
                                    ...
                                    <div class="clear">
                                        ...
                                        <p class="text-muted m-b-0">{!! $details !!}.. <a
                                                href="{{ route('topicsEdit', ['webmasterId' => $Topic->webmaster_id, 'id' => $Topic->id]) }}"><strong>[
                                                    {{ __('backend.viewDetails') }} ]</strong></a></p>
            ...
            @if (count($company) > 0)
                <div class="tab-pane p-v-sm  {{ $active_tab == 6 ? 'active' : '' }}" id="tab_6">
                    <div class="box m-t p-a-sm">
                        <ul class="list m-b-0">
                            <?php
                            ...
                            @foreach ($company as $value)
                                ...
                                <li class="list-item">
                                    <div class="clear">
                                        <h5 class="m-a-0 m-b-sm text-primary">{{ $title }} </h5>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
            ...
            @if (count($shipment) > 0)
                <div class="tab-pane p-v-sm  {{ $active_tab == 7 ? 'active' : '' }}" id="tab_7">
                    <div class="box m-t p-a-sm">
                        <ul class="list m-b-0">
                            <?php
                            $title_var = 'name_' . @Helper::currentLanguage()->code;
                            ...
                            @foreach ($shipment as $value)
                                ...
                                <li class="list-item">
                                    <div class="clear">
                                        <h5 class="m-a-0 m-b-sm text-primary">{{ $value->receiver_name }} </h5>
                                    </div>
                                </li>
                            @endforeach
                        </ul>
