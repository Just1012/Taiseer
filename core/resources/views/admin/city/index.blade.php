                    ...
                    <table class="table table-bordered m-a-0">
                        <thead class="dker">
                            <tr>
                                ...
                                <th class="text-center">{{ __('backend.country') }}</th>
                        ...
                        <tbody>
                            ...
                            @foreach ($city as $WebSection)
                                ...
                                <tr>
                                    ...
                                    <?php
                                    if ($WebSection->$name_var != '') {
                                        $name = $WebSection->country->$name_var;
                                    } else {
                                        $name = $WebSection->country->$name_var2;
                                    }
                                    ?>
                                    <td class="h6">{{ $name }}</td>
                                    ...
                                    <td class="text-center">
                                        <a class="btn btn-sm info"
                                            href="{{ route('city.Edit', ['id' => $WebSection->id]) }}">
                                    ...
                                    <div class="modal-dialog" id="animate">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ route('city.updateStatus', ['id' => $WebSection->id]) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3 text-center">
                            <small class="text-muted inline m-t-sm m-b-sm">{{ __('backend.showing') }}
                                {{ $city->firstItem() }}
                                -{{ $city->lastItem() }} {{ __('backend.of') }}
                                <strong>{{ $city->total() }}</strong> {{ __('backend.records') }}
                            </small>
                        </div>
